...
is based on official nginx release 1.30.2 and zig 0.16. nginz is tested with linux only.
...
- **nginx version**: Modules are built against nginx 1.30.2. Using with other versions may cause
